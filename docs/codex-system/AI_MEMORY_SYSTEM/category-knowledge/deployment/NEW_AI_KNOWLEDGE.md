...
Module 37 expanded the same local-only seed family with Water Emergency aging and follow-up examples for newly opened, active monitoring, follow-up due, follow-up overdue, stale evidence, waiting review, ready-for-close-review, closed/resolved, and unknown timing visibility. These records remain synthetic, local-development-only read-model examples and must not imply production SLA rules, automatic escalation, workflow execution, or final ACS timing taxonomy.
