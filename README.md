...
- GET-only `/api/v1/auth/status` disabled auth status bridge with no Authorization requirement, header parsing, token verification, RBAC, route guarding, or action authority
