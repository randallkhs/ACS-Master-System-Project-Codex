...
const mockFutureAuthCutoverBlockers = [
  "provider_selection",
  "real_credentials",
  "secret_management",
  "auth_implementation",
...
const mockFutureAuthCutoverPrerequisites = [
  {
  ...
  },
  {
    ...
    reason:
      "Water Emergency action authority may affect legal, insurance, warranty, billing, or company-liability boundaries.",
  },
  {
...
const mockCurrentRouteAccessibilityAudit = [
  {
    method: "GET",
    route: "/api/v1/health",
...
export const mockAuthStatus: AuthStatusResponse = {
  ...
  future_auth_cutover_blocked_by: mockFutureAuthCutoverBlockers,
  future_auth_cutover_prerequisites: mockFutureAuthCutoverPrerequisites,
  current_route_accessibility_audit: mockCurrentRouteAccessibilityAudit,
...
const mockAuthRbacReadinessAudit: AuthRbacReadinessAuditResponse = {
  ...
  future_transition_prerequisites: [
    ...
    },
    {
      ...
      satisfied_now: false,
      requires_alfonso_owner_review: false,
      reason: "Real credentials must stay outside committed source files.",
    },
    {
      ...
      satisfied_now: false,
      requires_alfonso_owner_review: false,
      reason: "Token verification is not implemented in Phase 0.",
    },
    {
      key: "frontend_login_logout_ux_approved",
      label: "Frontend sign-in/sign-out UX approved",
      blocker_group: "token_verification",
      status: "blocked_by_auth_implementation",
      satisfied_now: false,
      requires_alfonso_owner_review: false,
      reason: "No sign-in or sign-out UI exists in Phase 0.",
    },
    {
      key: "claims_mapping_finalized",
      label: "Claims mapping finalized",
      ...
      satisfied_now: false,
      requires_alfonso_owner_review: false,
      reason: "Claims remain future-planning metadata only.",
    },
    {
      ...
      satisfied_now: false,
      requires_alfonso_owner_review: false,
      reason: "Operator identities are not persisted in Phase 0.",
    },
    {
      ...
      satisfied_now: false,
      requires_alfonso_owner_review: false,
      reason: "Roles remain provisional labels only.",
    },
    {
      ...
      satisfied_now: false,
      requires_alfonso_owner_review: false,
      reason: "Permissions remain future labels only.",
    },
    {
      ...
      satisfied_now: false,
      requires_alfonso_owner_review: false,
      reason: "The matrix remains planning metadata until a future review.",
    },
    {
      ...
      satisfied_now: false,
      requires_alfonso_owner_review: false,
      reason: "Route guards are not implemented in Phase 0.",
    },
    {
      ...
      satisfied_now: false,
      requires_alfonso_owner_review: false,
      reason: "Manual Review action permissions remain future work.",
    },
    {
    ...
    },
    {
      ...
      satisfied_now: false,
      requires_alfonso_owner_review: false,
      reason: "Future actions require audit actor and idempotency design.",
    },
    {
      ...
      satisfied_now: false,
      requires_alfonso_owner_review: false,
      reason: "Future action modules need recovery behavior before mutations exist.",
    },
    {
      ...
      requires_alfonso_owner_review: true,
      reason:
        "Legal, insurance, billing, warranty, and customer policy need owner review.",
    },
    {
      ...
      satisfied_now: true,
      requires_alfonso_owner_review: false,
      reason: "The auth configuration safety helper remains part of verification.",
    },
    {
      ...
      satisfied_now: false,
      requires_alfonso_owner_review: false,
      reason: "Each module updates ACSSDR only for the prior committed module.",
    },
    {
      ...
      satisfied_now: true,
      requires_alfonso_owner_review: false,
      reason: "External review remains mandatory before commit.",
    },
  ],
};
...
export const mockManualReviewQueue: ManualReviewQueueResponse = {
  ...
  auth_boundary_readiness: {
    ...
    auth_rbac_readiness_audit: mockAuthRbacReadinessAudit,
  },
  audit_correlation_count: 5,
  taxonomy_metadata: {
